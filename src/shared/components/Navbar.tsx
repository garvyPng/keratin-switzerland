...
export default function Navbar() {
    ...
    return (
        <header className='absolute top-0 left-0 w-full font-syne z-50 font-heading text-white'>
            <div className='mx-auto w-full max-w-[1280px] sm:px-6 lg:px-8 flex items-center justify-between px-4 py-4'>
                ...
                <nav className='flex absolute md:relative top-20 md:top-0 gap-6 text-sm font-normal'>
                    <button
